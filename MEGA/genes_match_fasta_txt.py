...
# ===================== 配置 =====================
GENE_TXT = "human_genes.txt"
HOMOLOGY_FILE = "human_to_mouse.txt"
FASTA_HUMAN   = "human_mus_cds_longest.fasta"
FASTA_MOUSE   = "mouse_hu_cds_longest.fasta"
OUTPUT_DIR    = "homogenes/human"
PATH_FILE     = "seq_path_human.txt"

# =================================================

os.makedirs(OUTPUT_DIR, exist_ok=True)

df_genes = pd.read_csv(GENE_TXT, sep="\t", dtype=str)
target_genes = df_genes.iloc[:, 0].str.strip().unique()
